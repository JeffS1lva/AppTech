...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
    return(
        <Tabs.Trigger 
        value={value} 
        className=" dark:text-zinc-400 group relative px-1 pb-4 text-sm font-medium text-zinc-500 hover:text-violet-700 data-[state=active]:text-violet-300 outline-none dark:data-[state=active]:text-violet-300 dark:hover:text-violet-300">
